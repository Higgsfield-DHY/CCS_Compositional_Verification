...
/**
 * Adapted from FM2026 RealCases/Fischer/TA4.
 */
public class FischerTa4Source extends FischerChannelExperiment {
    @Override
    ...
    public String getNtaPath() {
        return ".\\src\\main\\resources\\verification\\fischer_ta4_source.xml";
    }
}
