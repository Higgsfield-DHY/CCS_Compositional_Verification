...
public final class Autosar3ChannelRunner {
    private Autosar3ChannelRunner() {
    }
    ...
    public static void main(String[] args) throws IOException {
        String presetCase = "Experiment3_1";
        // presetCase = "Experiment3_2";
        // presetCase = "Experiment3_3";
        ...
        Autosar3ChannelCase scenario = Autosar3ChannelCases.findById(selected);
        if (scenario == null) {
            throw new IllegalArgumentException("Unknown case: " + selected
                    + ". Available: " + Autosar3ChannelCases.availableCases());
        }
    ...
    public static RunSummary runCaseById(String caseId) throws IOException {
        Autosar3ChannelCase scenario = Autosar3ChannelCases.findById(caseId);
        if (scenario == null) {
    ...
    public static RunSummary runCase(Autosar3ChannelCase scenario) throws IOException {
        return runCase(scenario, LogMode.SUMMARY, ChannelExperimentSupport.DEFAULT_TIMEOUT_MS);
    }
    ...
    public static RunSummary runCaseDetailed(Autosar3ChannelCase scenario) throws IOException {
        return runCase(scenario, LogMode.DETAILED, ChannelExperimentSupport.DEFAULT_TIMEOUT_MS);
    }
    ...
    public static RunSummary runCase(Autosar3ChannelCase scenario, long timeoutMs) throws IOException {
        return runCase(scenario, LogMode.SUMMARY, timeoutMs);
    }

    public static RunSummary runCaseDetailed(Autosar3ChannelCase scenario, long timeoutMs) throws IOException {
    ...
    private static RunSummary runCase(Autosar3ChannelCase scenario, LogMode logMode, long timeoutMs) throws IOException {
    ...
    public static void printSummary(RunSummary s) {
        System.out.println("============================================================");
        System.out.println("AUTOSAR-3 Channel Summary");
