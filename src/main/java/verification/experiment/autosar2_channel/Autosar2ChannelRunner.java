...
public final class Autosar2ChannelRunner {
    private Autosar2ChannelRunner() {
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        Autosar2ChannelCase scenario = Autosar2ChannelCases.findById(selected);
        if (scenario == null) {
    ...
    public static RunSummary runCaseById(String caseId) throws IOException {
        Autosar2ChannelCase scenario = Autosar2ChannelCases.findById(caseId);
        if (scenario == null) {
    ...
    public static RunSummary runCase(Autosar2ChannelCase scenario) throws IOException {
        return runCase(scenario, LogMode.SUMMARY, ChannelExperimentSupport.DEFAULT_TIMEOUT_MS);
    }
    ...
    public static RunSummary runCaseDetailed(Autosar2ChannelCase scenario) throws IOException {
        return runCase(scenario, LogMode.DETAILED, ChannelExperimentSupport.DEFAULT_TIMEOUT_MS);
    }

    public static void runCaseWithSummary(String caseId) throws IOException {
        RunSummary summary = runCaseDetailed(caseId, ChannelExperimentSupport.DEFAULT_TIMEOUT_MS);
        printSummary(summary);
        if (!"PASS".equals(summary.getStatus())) {
    ...
    public static RunSummary runCase(Autosar2ChannelCase scenario, long timeoutMs) throws IOException {
        return runCase(scenario, LogMode.SUMMARY, timeoutMs);
    }

    public static RunSummary runCaseDetailed(Autosar2ChannelCase scenario, long timeoutMs) throws IOException {
        return runCase(scenario, LogMode.DETAILED, timeoutMs);
    }
    ...
    private static RunSummary runCase(Autosar2ChannelCase scenario, LogMode logMode, long timeoutMs) throws IOException {
        ...
        summary.setBoundaryCase(scenario.isBoundaryCase());
    ...
    public static void printSummary(RunSummary s) {
        System.out.println("============================================================");
        System.out.println("AUTOSAR-2 Channel Summary");
    ...
    public static class RunSummary {
        ...
        public void setVerifyGoal(String verifyGoal) {
        ...
        public void setPartitionNote(String partitionNote) {
        ...
        public String getTargetSigma() {
            return targetSigma;
        }

        public void setTargetSigma(String targetSigma) {
            this.targetSigma = targetSigma;
        }

        public String getResetSigma() {
            return resetSigma;
        }

        public void setResetSigma(String resetSigma) {
        ...
        public String getAgVerdict() {
            return agVerdict;
        }

        public void setAgVerdict(String agVerdict) {
            this.agVerdict = agVerdict;
        }
        ...
        public int getCq1Fails() {
            return cq1Fails;
        }

        public void setCq1Fails(int cq1Fails) {
            this.cq1Fails = cq1Fails;
        }

        public int getCq2Fails() {
            return cq2Fails;
        }

        public void setCq2Fails(int cq2Fails) {
        ...
        public boolean isBoundaryCase() {
            return boundaryCase;
        }

        public void setBoundaryCase(boolean boundaryCase) {
        ...
        public long getDirectTimeMs() {
            return directTimeMs;
        }

        public void setDirectTimeMs(long directTimeMs) {
            this.directTimeMs = directTimeMs;
        }
