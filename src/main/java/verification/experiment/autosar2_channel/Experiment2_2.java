...
public class Experiment2_2 extends Autosar2BufferChannelExperiment {
    @Override
    ...
    protected Template buildObservedBuffer() {
        return AutosarEx2Util.buildBuffer1();
    }

    @Override
    protected boolean includeObservedBuffer(Template template) {
        return !"buffer1".equals(template.getName());
    }
    ...
    public String getNtaPath() {
        return ".\\src\\main\\resources\\verification\\autosar2_channel_ex2-source.xml";
    }
}
